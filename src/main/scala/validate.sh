...
# Configuration:
# Change the paths!
# Insert the path to validation data here
teacher_test_path="C:\Users\II\idrisg\ScalaAssignment\ValidationData"

# Challenge mode (optional)
#teacher_test_path="C:/Users/ander/IKT212/ValidationData/challenges/"
